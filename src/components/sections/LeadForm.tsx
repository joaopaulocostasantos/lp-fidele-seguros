          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
            ...
            >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2.5 rounded-2xl border border-[#21A621]/30 bg-[#21A621]/15 p-4 text-sm font-medium text-white hover:bg-[#21A621]/25 transition-colors"
              >
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current text-[#21A621]" xmlns="http://www.w3.org/2000/svg">
